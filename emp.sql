...
("rahul",20000,'2021-06-11'),
("raju",30000,'2010-06-20'),
("Adeena",40000,'2022-06-20');
#uc4
select * from empPayroll;

#uc5
select * from empPayroll where salay=20000;
select salay from empPayroll where name="rahul";
...
update empPayroll set gender='F' where name='Adeena';

set sql_safe_updates=1;
select * from empPayroll;
set sql_safe_updates=0;
update empPayroll set gender="M" where name='rahul' or name='raju';
set sql_safe_updates=1;
...
describe empPayroll;
set sql_safe_updates=0;
update empPayroll set emp_phone=8888884188  where name='rahul';
set sql_safe_updates=1;
select * from empPayroll;
set sql_safe_updates=0;
update empPayroll set emp_phone=888888778  where name='Adeena';
set sql_safe_updates=1;
set sql_safe_updates=0;
set sql_safe_updates=1;
select * from empPayroll;
...
insert into empPayroll (name,department,gender,salay,start) value("puja","sales","F",60000,"2021-11-30");
